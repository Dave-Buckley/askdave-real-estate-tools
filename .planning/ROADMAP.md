...
Plans:
- [x] 08-01-PLAN.md — Data model (12 communities) + list/detail views with search, sort, and SVG charts
- [x] 08-02-PLAN.md — Side-by-side comparison table + WhatsApp share with editable preview
